...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            obj.M = 1;
            if isempty(obj.D); obj.D = 1506; end
        ...
        function PopObj = CalObj(obj,X)
            ...
            PopObj = pyrunfile("mat_eval_env.py","fitnesses",env="Reacher-v4_small", agent='A2C', policy='MlpPolicy', weights=X);
