function Offspring = OperatorGAMB(Problem,Parent,UMB)
...
%--------------------------------------------------------------------------
    ...
    UMB_Offspring = GAreal(Parent1,Parent2,UMB_lower(UMB),UMB_upper(UMB),proC,disC,proM*length([Type{1:2}])/size(Parent1,2),disM);
