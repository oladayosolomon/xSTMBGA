# -*- coding: utf-8 -*-
"""
Created on Wed Oct 15 14:37:47 2025
...
Train PPO 30 times on multiple environments (each with custom timesteps & episodes)
...
n_runs =30  # set to 30 for full experiment
results = []
...
for env_id, config in env_configs.items():
    ...
    for run in range(n_runs):
        ...
        model = PPO("MlpPolicy", vec_env, policy_kwargs={'net_arch': [32, 32]}, verbose=0, device="cpu")
...
df.to_csv("ppo_env_rewards.csv", index=False)
print("\n✅ All results saved to 'ppo_env_rewards.csv'")
